...
/* harmony import */ var _modules_checkTextInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/checkTextInput */ "./src/js/modules/checkTextInput.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="name"]');
  Object(_modules_checkTextInput__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="message"]');
  Object(_modules_showMoreStyles__WEBPACK_IMPORTED_MODULE_5__["default"])('.button-styles', '#styles .row');
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price', formState);
  Object(_modules_filter__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_sizes__WEBPACK_IMPORTED_MODULE_8__["default"])();
...
var accordion = function accordion(triggerSelector, blockSelector) {
  var btns = document.querySelectorAll(triggerSelector);
  var blocks = document.querySelectorAll(blockSelector);

  function hideBlock(block) {
    block.classList.remove('animate__animated', 'animate__fadeInDown', 'active-block');
  ...
  btns.forEach(function (item) {
    item.addEventListener('click', function () {
      ...
      if (this.classList.contains('active-style')) {
        ...
        this.nextElementSibling.classList.add('animate__animated', 'animate__fadeInDown', 'active-block');
...
var calc = function calc(size, material, options, promocode, result, state) {
  ...
  var materialEl = document.querySelector(material);
...
var drop = function drop() {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots = fileName.length > 5 ? '...' : '.';
      var text = fileName.split('.')[0].slice(0, 5) + dots + fileName.split('.')[1];
      ...
      if (input.closest('.file_upload').getAttribute('data-input') === 'send') {
        ...
        Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])('assets/server.php', formData).then(function (res) {
          ...
          return setTimeout(function () {
            return input.closest('.file_upload').textContent = 'Фото добавлено на сервер';
          }, 2000);
        });
      }
    });
...
var filter = function filter() {
  var btnWrapper = document.querySelector('.portfolio-menu');
  var btns = btnWrapper.querySelectorAll('li');
  var portfolioWrapper = document.querySelector('.portfolio-wrapper');
  var portfolios = document.querySelectorAll('.portfolio-block');
  ...
  function addFilter(e) {
    ...
    var filterCategory = target.className;
    var filtred = 0;
    ...
    item.addEventListener('submit', function (e) {
      ...
      if (item.getAttribute('data-calc') === 'end') {
        for (var prop in state) {
          ...
          console.log("".concat(prop, ": ").concat(state[prop]));
        }
      }

      var api = item.classList.contains('form-calc') ? path.designer : path.question;
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_8__["postData"])(api, formData).then(function (res) {
        ...
        item.reset();
        document.querySelectorAll('[type="file"]').forEach(function (item) {
...
var scrolling = function scrolling() {
  ...
  var btnUp = document.querySelector('.pageup');
  ...
  links.forEach(function (item) {
    item.addEventListener('click', function (e) {
      if (this.hash !== '') {
        e.preventDefault(); //Old way

        var targetEl = document.querySelector(this.hash);
        var targetElCoords = targetEl.getBoundingClientRect();
        window.scrollTo({
...
var sizes = function sizes() {
  var sizesBlocks = document.querySelectorAll('.sizes-block');

  function showPicture(e) {
    var target = e.target;
    var img = target.querySelector('img');
    var src = img.getAttribute('src');
    var newSrc = src.split('.')[0] + '-1.' + src.split('.')[1];
  ...
  function hidePicture(e) {
    ...
    var img = target.querySelector('img');
    var src = img.getAttribute('src');
    var newSrc = src.split('.')[0].slice(0, -2) + '.' + src.split('.')[1];
    img.setAttribute('src', newSrc);
  ...
  sizesBlocks.forEach(function (item) {
...
var slider = function slider(slide, dirrection, prevBtn, nextBtn) {
  var slideIndex = 1;
  var paused = false;
  ...
  activeteAnimation();
  slides[0].parentNode.addEventListener('mouseover', function () {
